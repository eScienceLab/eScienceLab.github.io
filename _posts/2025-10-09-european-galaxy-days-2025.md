...
Stian Soiland-Reyes and Eli Chadwick represented the eScience Lab on the following topics:
- [RO-Crate](/products/researchobject/) and [WorkflowHub](/products/workflowhub/) in Galaxy
- Galaxy community projects using RO-Crate
- EuroScienceGateway final meeting

For details, please [visit the RO-Crate blog](https://www.researchobject.org/ro-crate/blog/2025-10-09/ro-crate-at-european-galaxy-days-2025).
